...
exports.post_nueva_arma = (request, response, next) => {    
    const arma = new Armas(request.body.nombre, request.body.descArma,request.file.filename);
    arma.save().then(() => {
...
exports.post_nuevo_man = (request, response, next) => {    
    const man = new Manufactureros(request.body.nombre, request.body.descMan,request.file.filename);
    man.save().then(() => {
